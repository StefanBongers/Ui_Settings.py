...
class Ui_beringerverwaltung(object):
    def setupUi(self, beringerverwaltung):
        ...
        beringerverwaltung.resize(1137, 350)
        ...
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(beringerverwaltung)
        ...
        self.horizontalLayout.addWidget(self.CMB_nachname)
        ...
        self.horizontalLayout.addWidget(self.CMB_nachname_2)
        ...
        self.verticalLayout.addWidget(self.BTN_neu)
        ...
        self.horizontalLayout_3.addWidget(self.BTN_speichern)
        ...
        self.horizontalLayout_3.addWidget(self.BTN_abbrechen)
        ...
        self.horizontalLayout_3.addWidget(self.BTN_aktivieren)
    ...
    def retranslateUi(self, beringerverwaltung):
        ...
        self.BTN_neu.setText(_translate("beringerverwaltung", "Neuen Beringer anlegen ... "))
